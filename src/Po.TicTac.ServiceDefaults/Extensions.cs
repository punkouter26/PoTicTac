...
{
    /// <summary>
    /// Adds Aspire service defaults to the application.
    /// Call this in Program.cs after creating the builder.
    /// </summary>
    ...
    private static IHostApplicationBuilder AddOpenTelemetryExporters(this IHostApplicationBuilder builder)
    {
        ...
        // Export to Azure Monitor / Application Insights when connection string is configured
    ...
    /// <summary>
    /// Maps default Aspire endpoints including health checks.
    /// Call this in Program.cs after building the app and before app.Run().
    /// </summary>
